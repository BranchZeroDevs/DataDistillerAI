"""
Updated RAG Pipeline that supports Ollama (local) or OpenAI (cloud)
"""
...
class RAGPipelineOllama:
    """
    RAG Pipeline using Ollama (local, free)
    
    Usage:
        pipeline = RAGPipelineOllama(document_path="./data/documents")
    ...
    def __init__(
        ...
        logger.info(f"Initialized RAG Pipeline with Ollama ({model})")
...
RAGPipeline = RAGPipelineOllama

__all__ = ['RAGPipelineOllama', 'RAGPipeline']
